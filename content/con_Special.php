...
<body onLoad="init()">
  ...
  <div class="spec_text_1">特色菜单--</div>
    <div class="spec_text_2">特色类</div>
    <div class="tab">
	
        <div class="tab_menu">
		
		<form><a href="dingdan_S.php?">
            ...
            <?php
                ...
                while($myrow=mysqli_fetch_array($result))
                {
                    ...
                    if($i==1){		
                        $i++;
            ?>
                <li class="selected"><?php echo $myrow['s_name'];?></li>
            <?php
            }
            else{
            ?>		
                <li><?php echo $myrow['s_name'];?></li>
            <?php
            }
                }
            ?>
        ...
        <div class="tab_box"> 
             ...
             <?php
                ...
                while($myrow=mysqli_fetch_array($result))
                {
                    ...
                    if($i==1){		
                        $i++;
            ?>
                <div><span class="style">名称:</span><?php echo $myrow['s_name'];?>
                <br><span class="style">价格:</span><?php echo $myrow['s_price'];?>&nbsp;&nbsp;<br>
				<span class="style">数量:</span><?php echo $myrow['s_num'];?>
                <br><span class="style">内容:</span><?php echo $myrow['s_content'];?>
                <div class="box"><img class="img" src="../admin/<?php echo $myrow['s_pic'];?>"/>				  
                </div>
            ...
            <?php
                ...
                ?>			
                <div class="hide"><span class="style">name:</span><?php echo $myrow['s_name'];?>
                <br><span class="style">price:</span><?php echo $myrow['s_price'];?>&nbsp;&nbsp;<br>
				<span class="style">number:</span><?php echo $myrow['s_num'];?>
                <br><span class="style">content:</span><?php echo $myrow['s_content'];?>
