...
<tr>
    ...
    <td colspan="3" align="center" class="style4">菜单管理-肉类</td>
</tr>
...
<tr align="center" >
    ...
    <td  class="style4">操作/<a href="cdgl_M_add.php?">增加</a></td>
</tr>
  
 
  <?php 
       $page_size=6;
       $query="select * from con_meat where m_id";
	   $result=mysqli_query($conn,$query);
	   $message_count=mysqli_num_rows($result);
	   $page_count=ceil($message_count/$page_size);
	   
	   $offset=($page-1)*$page_size;
	   $query="select * from con_meat where m_id order by m_id desc limit $offset,$page_size";
  ...
  <tr align="center" onMouseDown="this.bgColor='#C4E1FF'" onMouseOut="this.bgColor='#FFE1E1'" onMouseMove="this.bgColor='#DDFFFF'">
    <td height="30"><span class="style3"><?php echo $myrow['m_name'];?></span></td>
    <td class="style5"><?php echo $myrow['m_price'];?></td>
    <td class="style5"colspan="3"><?php echo $myrow['m_content'];?></td>
	<td colspan="2"><img id="photo" src="<?php echo $myrow['m_pic'];?>"/></td>

	
    <td class="style5">
	<a href="delete.php?lmbs=<?php echo urlencode('菜单管理-meat');?>&m_id=<?php echo $myrow['m_id'];?>">删除</a>
	<a href="M_update.php?lmbs=<?php echo urlencode('菜单管理-meat');?>&m_id=<?php echo $myrow['m_id'];?>">修改</a>
	</td>
...
<?php
		if($page >= 2){
?>
			<a href="index.php?lmbs=菜单管理-meat&page=<?php echo $page-1;?>">上一页</a>
<?php
		
		}
		if($page < $page_count){
?>
			<a href="index.php?lmbs=菜单管理-meat&page=<?php echo $page+1;?>">下一页</a>
<?php
		}
		if($page >= $page_count){		
?>
			<a href="index.php?lmbs=菜单管理-meat&page=<?php echo $page_count;?>">尾页</a>
            <?php 
		}
			?>
        </td>
