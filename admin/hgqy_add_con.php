  ...
  <tr>
    <td width="776"><table width="776" height="400"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form name="myform" method="post" action="hgqy_add_okcon.php" enctype="multipart/form-data">

		  
          <tr>
            <td height="100" align="center" class="style1">火锅前沿:</td>
            <td align="left" valign="top">
              ...
              <textarea name="h_content" cols="50" rows="15" wrap="PHYSICAL" ></textarea></td>
          </tr>
          ...
          <tr>
            ...
            <td><input name="tj" type="submit"  value="提交-con" >
