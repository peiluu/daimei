...
<body>
  ...
  <tr>
    <td width="15">&nbsp;</td>
    <td width="760" height="100">&nbsp;&nbsp;== 傣妹传说 == </td>
  </tr>
</table>
  ...
  <tr>
    <td width="776"><table width="776" height="400"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form name="myform" method="post" action="dmcs_add_ok.php" enctype="multipart/form-data">
		...
		<tr>
            ...
            <td align="left" valign="top">              
              ...
              <input name="u_pass" type="hidden" id="u_pass" value="<?php echo $_SESSION['u_pass'];?>">
			    <textarea name="dm_content" cols="50" rows="15" wrap="PHYSICAL" ></textarea></td>
